...
{if $template == 'whmcsSettings' || $template == 'configuration'}

<h1>{'WHMCS_SETTINGS'|onapp_string}</h1>
    
        <table class="form-table two" width="100%" cellpadding="0" cellspacing="0" >

            <tr>
                <td class="label">{'API_FILE_URL'|onapp_string}</td>
                <td>

                        {$config.whmcs_api_file_url}

                </td>
            </tr>
            <tr>
                <td class="label">{'CLIENT_AREA_URL'|onapp_string}</td>
                <td>

                        {$config.whmcs_client_area_url}
            ...
            <tr>
                <td class="label">{'PASSWORD_'|onapp_string}</td>
                <td>

                        {$config.whmcs_password}

                </td>
            </tr>
             <tr>
                 <td>
                     <form action="{$config.base_url}/{$_ALIASES['whmcs_settings']}" method="post">
                         <input type="submit" value="{'EDIT_'|onapp_string}" />
                         <input type="hidden" name="action" value="edit" />
                     </form>
                </td>
